...
public class ProxCalRestore extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (f.exists()) {
            if (f.delete()) {
                toast = Toast.makeText(ProxCalRestore.this,
                        getString(R.string.delete_success), Toast.LENGTH_LONG);
            } else {
                toast = Toast.makeText(ProxCalRestore.this,
                        getString(R.string.delete_error), Toast.LENGTH_LONG);
            }
        } else {
            toast = Toast.makeText(ProxCalRestore.this, getString(R.string.delete_no_file),
                    Toast.LENGTH_LONG);
        }
        toast.show();
        finish();
